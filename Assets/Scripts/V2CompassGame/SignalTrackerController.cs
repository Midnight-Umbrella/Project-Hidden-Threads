...
public class SignalTrackerController : MonoBehaviour
{
    ...
    private SignalTarget currentTarget;
    ...
    private void Update()
    {
        ...
        if (currentTarget.IsCollected) return;
    ...
    public void StartTracking(SignalTarget target)
    {
    ...
    public void OpenTrackerPanel()
    {
        if (trackerPanel != null)
            trackerPanel.SetActive(true);
    }

    public void CloseTrackerPanel()
    {
        if (trackerPanel != null)
            trackerPanel.SetActive(false);
    }

    public SignalTarget GetCurrentTarget()
    {
